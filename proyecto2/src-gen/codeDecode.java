...
public final class codeDecode {
  ...
  public static void main(String[] args) {
    ...
    $try:try {
      ...
      $line=11;
      System.out.println($message(new Object[]{"w1!w2!w3!...!wn-1!wn# with n >= 2 and wi in ('a'..'d')"}));
      $line=12;
      System.out.println($message(new Object[]{"Output strings: Decoded original strings"}));
      $line=13;
